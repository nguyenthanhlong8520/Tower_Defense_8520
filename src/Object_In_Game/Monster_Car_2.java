...
public class Monster_Car_2 extends Monster{

    public Monster_Car_2(Image image, double x, double y, double rotate, double speed, double health, int rotate_blood) {
