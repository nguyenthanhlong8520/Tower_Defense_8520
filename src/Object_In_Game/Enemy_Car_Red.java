...
public class Enemy_Car_Red extends Enemy {

    public Enemy_Car_Red(Image image, double x, double y, double rotate, double speed, double health, int rotate_blood, GraphicsContext graphicsContext) {
    ...
    public void Blood_bar(List<Enemy> list_Enemy) {
        ...
        ImageView imageView5 = new ImageView("file:src/AssetsKit/min5.png");
        ...
        ImageView imageView4 = new ImageView("file:src/AssetsKit/min4.png");
        ...
        ImageView imageView3 = new ImageView("file:src/AssetsKit/min3.png");
        ...
        ImageView imageView2 = new ImageView("file:src/AssetsKit/min2.png");
        ...
        ImageView imageView1 = new ImageView("file:src/AssetsKit/min1.png");
