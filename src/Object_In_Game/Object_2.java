...
public class Object_2 extends Object_In_Game{
    int Toa_do_x ;
    int Toa_do_y ;
    int Speed;
    public Object_2(int toa_do_x, int toa_do_y, int speed) {
        Toa_do_x = toa_do_x;
        Toa_do_y = toa_do_y;
        Speed = speed;
    }
    ...
    public Image Create_Object(int x) {
        //Image Object = new Image("file:/home/nguyen/Desktop/Image/231.png");
        //
