...
public class Enemy_Car_Yellow extends Enemy {

    public Enemy_Car_Yellow(Image image, double x, double y, double rotate, double speed, double health, int rotate_blood, GraphicsContext graphicsContext) {
    ...
    public void Blood_bar(List<Enemy> list_Enemy) {
        ImageView imageView6 = new ImageView("file:src/AssetsKit/min6.png"); // xe vang`
        imageView6.setRotate(Rotate_Blood);
        SnapshotParameters params6 = new SnapshotParameters();
        params6.setFill(Color.TRANSPARENT);
        Image rotatedImage6 = imageView6.snapshot(params6, null);

        ImageView imageView5 = new ImageView("file:src/AssetsKit/min5.png"); // xe vang`
        ...
        ImageView imageView4 = new ImageView("file:src/AssetsKit/min4.png"); // xe vang`
        ...
        ImageView imageView3 = new ImageView("file:src/AssetsKit/min3.png"); // xe vang`
        ...
        ImageView imageView2 = new ImageView("file:src/AssetsKit/min2.png"); // xe vang`
        ...
        ImageView imageView1 = new ImageView("file:src/AssetsKit/min1.png"); // xe vang`
